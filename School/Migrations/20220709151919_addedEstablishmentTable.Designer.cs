...
namespace ACM.Migrations
{
    ...
    [Migration("20220709151919_addedEstablishmentTable")]
    partial class addedEstablishmentTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ACM.Models.ACMDataModelFactory.AcmPerson", b =>
                {
                    b.Property<Guid>("AcmPersonID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("CurrentPlacement")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("AcmPersons");
                });

            modelBuilder.Entity("ACM.Models.ACMDataModelFactory.AcmPersonBasicField", b =>
                {
                    b.Property<Guid>("AcmPersonBasicFieldID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("AcmPersonBasicFieldID");

                    b.ToTable("AcmPersonBasicFields");
                });

            modelBuilder.Entity("ACM.Models.ACMDataModelFactory.AcmPersonMetaData", b =>
                {
                    b.Property<Guid>("AcmPersonMetaDataID")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("AcmPersonMetaDataID");

                    b.HasIndex("AcmPersonID");

                    b.ToTable("AcmPersonMetaData");
                });
            ...
            modelBuilder.Entity("ACM.Models.Establishment", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ACM.Models.ACMDataModelFactory.AcmPerson", b =>
                {
                    ...
                    b.HasOne("ACM.Models.SystemModelFactory.Ethnicity", "Ethnicity")
                        .WithMany()
                        .HasForeignKey("EthnicityID");

                    b.HasOne("ACM.Models.SystemModelFactory.Gender", "Gender")
                        .WithMany()
            ...
            modelBuilder.Entity("ACM.Models.ACMDataModelFactory.AcmPersonMetaData", b =>
                {
                    b.HasOne("ACM.Models.ACMDataModelFactory.AcmPerson", "AcmPerson")
                        .WithMany()
                        .HasForeignKey("AcmPersonID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AcmPerson");
                });
