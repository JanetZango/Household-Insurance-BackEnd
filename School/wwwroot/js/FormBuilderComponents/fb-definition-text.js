(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
        typeof define === 'function' && define.amd ? define(factory) :
            (global.VueFBDefinitionText = factory());
}(this, (function () {
    var index = {
        name: 'fb-definition-text',
        ...
        template: ` <div class="text" v-if="value.childCode == 'TEXT'" v-on:dblclick="subSelectResponseItem($event)">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <input type="text" class="form-control" v-if="value.properties.isMultiline == false" />
                                <textarea class="form-control" v-if="value.properties.isMultiline == true" rows="4"></textarea>
                            </div>
                        </div>
                    </div>`
    };
