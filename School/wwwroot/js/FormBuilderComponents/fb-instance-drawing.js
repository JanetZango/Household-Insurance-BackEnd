(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() :
        typeof define === 'function' && define.amd ? define(factory) :
            (global.VueFBInstanceDrawing = factory());
}(this, (function () {
    var index = {
        name: 'fb-instance-drawing',
        ...
        watch: {
            drawingHistory: function () {
                this.validate();
            }
        },
        computed: {
            drawingHistory: function () {
                return this.value.instanceProperties.serializedPoints;
            },
        ...
        methods: {
            ...
            validate: function () {
                if (this.isMandatory === true && this.visible == true) {
                    if (this.drawingHistory != null && this.drawingHistory != '') {
        ...
        template: `<div class="number fb-instance-item" v-if="value.childCode == 'DRAWING' && visible == true">
                        <div class="row">
                              <div class="col-md-12">
                                        ...
                                        <div role="tabpanel" class="tab-pane active p-1" v-bind:id="'fbitemresult' + value.formDefinitionID + '_' + sindex + '_' + cindex + '_' + iindex + '_' + iiindex + '_' + diindex" v-bind:aria-labelledby="'fbitemresult-tab' + value.formDefinitionID + '_' + sindex + '_' + cindex + '_' + iindex + '_' + iiindex + '_' + diindex">
                                            <div class="row">
                                                <div class="col-md-6" v-if="readonly == false">
                                                     <drawing-pad v-model="value.instanceProperties"></drawing-pad><br />
                                                     <div class="row">
                                                        <div class="col-md-12">Note: Please remember to save your drawing when finished using the save icon</div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6" v-if="readonly == true">
                                                     <img :src="value.instanceProperties.drawingBase64" style="max-height:200px"></img>
                                                </div>
                                                <div class="col-md-6">
